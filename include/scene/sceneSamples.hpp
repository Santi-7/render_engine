...
Scene CornellBoxWithMedia()
{
    ...
    ParticipatingMedia fogBox(make_shared<Box>(Box(Rectangle(Vect(0,1,0), Point(0.2f,-0.25f, 0.3f), Point(-0.2f,-0.25f, -0.3f)), 0.3f)), 0.5f, 0.5f);
    ...
    cornellBox.AddShape(purpleSphere);
    // A point light illuminates the scene.
    cornellBox.AddLightSource(PointLight(Point(0, 0.6f, -0.1f), 1.5f, WHITE));
