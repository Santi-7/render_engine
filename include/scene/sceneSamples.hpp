...
Scene CornellBox()
{
    ...
    cornellBox.SetCamera(Pinhole(Vect(0,1,0), Vect(1,0,0), Vect(0,0,1), Point (0,0,0), (float)3.14159/2, 1.0, 255, 255));
    ...
    cornellBox.AddShape(Plane(Point(0, 0, 6), Vect(0,0,-1))); // Back wall
