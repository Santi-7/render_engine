...
Scene CornellBox()
{
    ...
    cornellBox.SetCamera(Pinhole(Vect(0,1,0), Vect(1,0,0), Vect(0,0,1), Point (0,0,0), (float)3.14159/2, 1.0, 1920, 1080));
   ...
   /* cornellBox.AddShape(Plane(Point(-4, 0, 0), Vect(1,0,0)));
    cornellBox.AddShape(Plane(Point(4, 0, 0), Vect(-1,0,0)));
    cornellBox.AddShape(Plane(Point(0, 4, 0), Vect(0,-1,0)));
    cornellBox.AddShape(Plane(Point(0, -4, 0), Vect(0,1,0)));
    cornellBox.AddShape(Plane(Point(0, 0, 6), Vect(0,0,-1)));*/


    // Two spheres inside the box.
    cornellBox.AddShape(Sphere(Point(-2, -1, 4), 1));
    cornellBox.AddShape(Sphere(Point(2, -1, 4), 1));
    cornellBox.AddLightSource(PointLight(Point(0, 0, 4)));
